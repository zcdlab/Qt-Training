...
private slots:
    ...
    void on_Red_lineEdit_textEdited(const QString &arg1);
    void timeout();
    void on_Green_lineEdit_textEdited(const QString &arg1);
    void on_Blue_lineEdit_textEdited(const QString &arg1);
};
