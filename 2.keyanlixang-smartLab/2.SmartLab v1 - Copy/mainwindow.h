...
private slots:
    ...
    void on_pushButton_light_fire_clicked();
    void on_pushButton_light_fire_2_clicked();
    void on_pushButton_light_fire_4_clicked();
    void on_pushButton_light_fire_3_clicked();
    void on_pushButton_light_fire_5_clicked();
    void on_pushButton_light_fire_6_clicked();
    void on_pushButton_light_fire_7_clicked();
    void on_pushButton_light_fire_8_clicked();
};
