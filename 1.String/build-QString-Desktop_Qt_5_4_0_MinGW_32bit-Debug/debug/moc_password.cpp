...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_password_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_password_t qt_meta_stringdata_password = {
    {
QT_MOC_LITERAL(0, 0, 8), // "password"
QT_MOC_LITERAL(1, 9, 30), // "on_pushButton_passWord_clicked"
QT_MOC_LITERAL(2, 40, 0) // ""

    },
    "password\0on_pushButton_passWord_clicked\0"
    ""
};
...
void password::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_pushButton_passWord_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *password::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_password.stringdata))
